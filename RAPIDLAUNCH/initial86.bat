...
@if %ERRORLEVEL% == 1 (echo READY TO LAUNCH CPSI&&pause&&\\kvhd-data2\Software\Everyone\CPSI\CWRUNNERcpsetup.exe&&echo READY TO LAUNCH E-FORMS FOR CPSI&&pause&&\\kvhd-data2\Software\Everyone\CPSI\cpsiefsetup.exe&&"\\kvhd-data2\Software\Everyone\All Scripts - Requires Admin Access\ENABLE CPSI Permissions.bat"&&"\\kvhd-data2\Software\Everyone\All Scripts - Requires Admin Access\X32\reg1.reg"&&"\\kvhd-data2\Software\Everyone\All Scripts - Requires Admin Access\X32\reg2.reg"&&echo !!!CPSI INSTALLED!!!)
@echo .
@echo .
